...
?>
                ...
                <input id="<?php $partenaire ?>" name="modification_statut_salle"
                    class="btn btn-outline-success btn-lg reset partenaire" type="submit" value="Valider"
                    onclick="return script_etiquette_salle_de_sport()">
