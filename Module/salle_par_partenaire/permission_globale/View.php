...
<link href="../../Style/Toggleswitch/ajouter_une_salle.css" rel="stylesheet" type="text/css" />
...
<input class="display_none" type="text" id="template" name="template" value="modifications_permissions_globales">
        ...
        <input name="inscription_partenaire" class="btn btn-outline-success btn-lg lecture_structure" type="submit"
