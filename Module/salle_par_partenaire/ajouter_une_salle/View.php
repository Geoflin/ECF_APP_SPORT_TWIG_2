...
<link href="../../Style/Toggleswitch/ajouter_une_salle.css" rel="stylesheet" />
</head>
...
<body>
  ...
  foreach ($pdo->query('SELECT * FROM api_clients WHERE client_id LIKE "'.$Salle_active['client_id'].'" ', PDO::FETCH_ASSOC) as $api_clients) { ?>
            ...
            <?php $permissions= array ("Lire", "Ecrire", "Ajouter", "Ajouter une production", "Lecture des paiements", "Lecture des statistques", "Abonnement", "Lecture des horaires de paiements", "Ecriture des paiements", "Lecture des jours de paiements"); ?>
        ...
        <input name="ajouter_une_salle" class="btn btn-outline-success btn-lg lecture_seul" type="submit" value="Valider" onclick="return script_ajout_salle_de_sport()">
